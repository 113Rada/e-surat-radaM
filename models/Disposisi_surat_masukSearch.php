...
/**
 * Disposisi_surat_masukSearch represents the model behind the search form of `app\models\Disposisi_surat_masuk`.
 */
class Disposisi_surat_masukSearch extends Disposisi_surat_masuk
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = Disposisi_surat_masuk::find();
